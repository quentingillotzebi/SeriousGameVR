...
public class DespawnAuthorized : MonoBehaviour
{
    ...
    void OnTriggerEnter(Collider other)
    {
        if (other.gameObject.CompareTag("Lugage"))
        {
            ...
            if (luggageController != null && luggageEtiquette == "AUTHORIZED")
            {
            ...
            else if (luggageController != null && luggageEtiquette == "ANALYZABLE")
            {
