...
public class DespawnUnauthorized : MonoBehaviour
{
    ...
    void OnTriggerEnter(Collider other)
    {
        if (other.gameObject.CompareTag("Lugage"))
        {
            ...
            if (luggageController != null && luggageEtiquette == "UNAUTHORIZED")
            {
                gameManager.AddScore(100);
            }
            else if (luggageController != null && luggageEtiquette == "AUTHORIZED" || luggageEtiquette == "ANALYZABLE")
            {
